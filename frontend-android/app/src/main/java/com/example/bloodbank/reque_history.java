 ...
 * {@link reque_history.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link reque_history#newInstance} factory method to
 * create an instance of this fragment.
 */
public class reque_history extends Fragment implements RequestCallback{
     ...
     * @return A new instance of fragment reque_history.
     */
    // TODO: Rename and change types and number of parameters
    public static reque_history newInstance(String param1, String param2) {
        reque_history fragment = new reque_history();
        ...
        try{
            ...
            if(ok){
                ...
                for(int i = 0; i<requeHistory.length(); i++){
                    ...
                    Log.d("RequeList", history.toString());
                    if(history.getInt("accepted") == 1){
                        Date ud = new Date(history.getLong("date_accepted") * 1000);
                        useDate = ud.toString();
                    }
                    reque_history_listitem listItem = new reque_history_listitem(
                            (new Date(history.getLong("date_requested") * 1000)).toString() ,
                            history.getInt("accepted") == 1 ? "Yes" : "No",
                            useDate
