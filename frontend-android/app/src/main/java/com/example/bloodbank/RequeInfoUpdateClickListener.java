...
public class RequeInfoUpdateClickListener implements RequestCallback, View.OnClickListener {
    SharedPreferences prefs;
    JSONArray bloodTypes;
    Context ctx;
    View mParentView;
    public RequeInfoUpdateClickListener(Context c, View parent){
        ...
        try {
            ...
            if (ok) {
                ...
                if(obj.has("types")){
                    ...
                    navController.navigate(R.id.action_des_reque_upinfo_to_des_reque_dash);
                }
            } else {
                Log.d("misc", "not ok");
